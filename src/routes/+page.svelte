...
<main class="bg-white">
  <section>
    <div
      class="relative grid w-full bg-sky-300 h-96 lg:h-[32rem] place-items-center"
    >
      <div class="flex flex-col items-center mx-auto text-center">
        ...
        <p class="mt-6 text-lg leading-5 text-white">texto aqui.</p>
    ...
    <div class="lg:flex lg:items-center lg:-mx-4">
      <div class="lg:w-1/2 lg:px-4">
        ...
        <p class="mt-6 text-gray-500">
          Somos uma gráfica tradicional situada em Feira de Santana, Bahia.
          <br />
          Com mais de 20 anos de mercado, atendemos clientes em todo o território
          nacional.
          <br />
          Nossa estrutura comporta 30 colaboradores e dispomos das melhores tecnologias
          em máquinas offset e digitais.
          <br />
          Isso nos permite entregar trabalhos com qualidade e agilidade.
          <br />
          Oferecemos uma ampla variedade de impressos como cartazes, cartões de visita,
          panfletos, pastas, envelopes, etiquetas, cardápios, crachás, agendas, blocos,
          revistas, livros e caixas personalizadas. Atendemos desde o cliente pessoa
          física até grandes empresas e franquias.
          <br />
          Na Gráfica Plantão você encontra profissionais focados em oferecer o que
          há de melhor no mercado gráfico, com preços competitivos e alto padrão
          de qualidade. Trabalhamos para superar expectativas e entregar produtos
          que fortaleçam a imagem dos nossos clientes.
        </p>
      </div>
      ...
      <div class="mt-8 lg:w-1/2 lg:px-4 lg:mt-0">
        <img
          ...
          src="Heidelberg-Speedmaster-SM-74-5-H.jpg"
          alt="Video thumbnail"
        />
      </div>
    </div>
  ...
  <section class="container px-6 py-8 mx-auto lg:py-16">
    <div class="grid grid-cols-1 gap-8 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
      <div class="p-8 space-y-3 border-2 border-sky-400 rounded-xl">
        <span class="inline-block text-sky-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-8 h-8"
            fill="none"
        ...
        <h1 class="text-2xl font-semibold text-gray-700 capitalize">Missão</h1>

        <p class="text-gray-500">
          Gerar soluções gráficas para atender as necessidades dos clientes, com
          qualidade, compromisso e eficácia. Exercer relação de respeito e valor
          com nossos colaboradores, fornecedores e âmbito social.
        </p>
      </div>
      ...
      <div class="p-8 space-y-3 border-2 border-sky-400 rounded-xl">
        ...
        <p class="text-gray-500">
          Ser reconhecida em todo território brasileiro por atuação de
      ...
      <div class="p-8 space-y-3 border-2 border-sky-400 rounded-xl">
        ...
        <p class="text-gray-500">
          Ética e transparência Compromisso Qualidade Valorização e capacitação
          da equipe Consolidação da relação com o cliente
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="container px-6 py-8 mx-auto lg:py-16">
    ...
    >
      ...
      <button
        class=" inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-sky-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl"
        >Cartões de visita</button
      >
      <button
        class=" inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-sky-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl"
        >Pastas personalizadas</button
      >
    </div>
  ...
  <section class="container px-6 py-8 mx-auto lg:py-16">
    ...
    <div
      class="grid grid-cols-1 gap-8 mt-8 md:mt-10 md:grid-cols-2 xl:grid-cols-3"
    >
      <div>
        <div class="relative">
          <img
        ...
        <hr class="w-32 my-6 text-sky-500" />
        ...
        <a
          href="#"
          class="inline-block mt-4 text-sky-500 underline hover:text-sky-400"
          >Read more</a
        >
      </div>
